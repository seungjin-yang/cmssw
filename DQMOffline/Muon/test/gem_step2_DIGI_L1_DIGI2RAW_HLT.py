...
# with command line options: step2 --conditions auto:phase1_2021_cosmics -s DIGI:pdigi_valid,L1,DIGI2RAW,HLT:@relval2021 --scenario cosmics --datatier GEN-SIM-DIGI-RAW -n 10 --geometry DB:Extended --era Run3 --eventcontent FEVTDEBUG --filein file:step1.root --fileout file:step2.root --no_exec
